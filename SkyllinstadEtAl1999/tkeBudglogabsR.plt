...
set ylabel "w'P'"
plot datdir.abrev."bR.dat" binary matrix u 1:2:(abs($3)) w image, \
...
set bmargin at screen bloc(row)
set ylabel "b'w'"
plot datdir.abrev."eR.dat" binary matrix u 1:2:(abs($3)) w image, \
...
set bmargin at screen bloc(row)
set ylabel "SP"
plot datdir.abrev."fR.dat" binary matrix u 1:2:(abs($3)) w image, \
...
set bmargin at screen bloc(row)
set ylabel "St"
plot datdir.abrev."gR.dat" binary matrix u 1:2:(abs($3)) w image, \
...
set bmargin at screen bloc(row)
set ylabel "sgs B"
plot datdir.abrev."hR.dat" binary matrix u 1:2:(abs($3)) w image, \
...
set mxtics 6
set ylabel "{/Symbol e}"
plot datdir.abrev."jR.dat" binary matrix u 1:2:(abs($3)) w image, \
